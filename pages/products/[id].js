      ...
      <div className="w-full pl-4 pr-8 mt-8 mb-8">
        <div className="bg-rd-bg px-5 py-4 rounded-lg">
          <p className="text-gray-400">
            Заявки &gt; Оформить заказ  &gt;<span className="text-rd-primary"> {foundItem.fullName}</span>
          </p>
            ...
            <div className="grid grid-cols-2 gap-x-4 my-6">
              ...
              <div>
                <h2 className="text-gray-400">Цена телефона</h2>
                  ...
                  <div>
                    <p className="inline bg-rd-secondary text-white font-semibold px-1 py-1 rounded-md">{foundItem.installment} сум </p> <span className="ml-3 text-gray-400">x3</span>
                  </div>
                </div>
                  <div className="my-3 border-rd-primary border-2 grid grid-cols-4 rounded-md ">
                    <span className=" py-2 text-center bg-rd-primary text-white border-rd-primary border-r-2">3 месяц</span>
                    <span className=" py-2 text-center text-rd-primary border-rd-primary border-r-2">3 месяц</span>
                    <span className=" py-2 text-center text-rd-primary border-rd-primary border-r-2">3 месяц</span>
                    <span className=" py-2 text-center text-rd-primary border-rd-primary">3 месяц</span>
                  </div>
                  <p className="text-center"> Наценка <span className="font-semibold">5%</span></p>
                  <div className="mt-8">
                    ...
                    <Link className="font-semibold text-rd-primary mt-4 block" href="#">Показать все</Link>
                  </div>
              </div>
            </div>
              ...
              isTick="1"
              />
          <button className="bg-rd-primary w-full rounded-full text-white py-4 text-center">Добавить в корзину</button>
          </div>
        </div>
      </div>
    </Layout>
